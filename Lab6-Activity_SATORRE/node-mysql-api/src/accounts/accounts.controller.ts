...
import validateRequest from '../_middlerware/validate-request';
import authorize from '../_middlerware/authorize';
...
function register(req: any, res: any, next: any) {
    console.log('Register endpoint called with email:', req.body.email);
    accountService.register(req.body, req.get('origin'))
        .then(() => {
            console.log('Registration successful for email:', req.body.email);
